...
- 季度: 2026Q1
- 月度: 2026.03
- 自定义: 2026.04.13~2026.04.19 或 20260413~20260419
"""
...
class PeriodParser:
    ...
    def _auto_detect(cls, period_str: str) -> PeriodInfo:
        ...
        raise ValueError(
            ...
            f"支持的格式: 2026, 2026Q1, 2026.03, 2026.04.13~2026.04.19, 20260413~20260419"
        )
    ...
    def _extract_short_label(cls, period_str: str) -> str:
        ...
        输入: 2026.04.13~2026.04.19 或 20260413~20260419
        输出: 04.13~04.19 或 0413~0419
        """
